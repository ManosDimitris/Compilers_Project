  ...
  private:
    ...
    struct symbol_kind
    {
      enum symbol_kind_type
      {
        ...
        S_statements = 19,                       // statements
        S_stmt = 20,                             // stmt
        S_expr = 21,                             // expr
        S_op = 22,                               // op
        S_term = 23,                             // term
        S_block = 24,                            // block
        S_funcdef = 25,                          // funcdef
        S_assignexpr = 26,                       // assignexpr
        S_ifstmt = 27,                           // ifstmt
        S_whilestmt = 28,                        // whilestmt
        S_forstmt = 29,                          // forstmt
        S_returnstmt = 30                        // returnstmt
      };
    };
