  ...
  private:
    ...
    struct symbol_kind
    {
      enum symbol_kind_type
      {
        ...
        S_KEYWORD = 3,                           // KEYWORD
        S_OPERATOR = 4,                          // OPERATOR
        S_INTCONST = 5,                          // INTCONST
        S_REAL = 6,                              // REAL
        S_STRING = 7,                            // STRING
        S_PUNCTUATION = 8,                       // PUNCTUATION
        S_ID = 9,                                // ID
        S_10_ = 10,                              // "="
        S_11_or_ = 11,                           // "or"
        S_12_and_ = 12,                          // "and"
        ...
        S_27_ = 27,                              // "."
        S_28_ = 28,                              // ".."
        S_BRACKETS = 29,                         // BRACKETS
        S_PARENTHESIS = 30,                      // PARENTHESIS
        ...
        S_op = 35,                               // op
        S_term = 36,                             // term
        S_assignexpr = 37,                       // assignexpr
        S_primary = 38,                          // primary
        S_lvalue = 39,                           // lvalue
        S_member = 40,                           // member
        S_call = 41,                             // call
        S_callsuffix = 42,                       // callsuffix
        S_normcall = 43,                         // normcall
        S_methodcall = 44,                       // methodcall
        S_elist = 45,                            // elist
        S_objectdef = 46,                        // objectdef
        S_block = 47,                            // block
        S_stmtlist = 48,                         // stmtlist
        S_funcdef = 49,                          // funcdef
        S_const = 50,                            // const
        S_idlist = 51,                           // idlist
        S_ifstmt = 52,                           // ifstmt
        S_whilestmt = 53,                        // whilestmt
        S_forstmt = 54,                          // forstmt
        S_returnstmt = 55                        // returnstmt
      };
    };
...
switch (yykind)
    ...
    // Implementation of make_symbol for each token kind.
      ...
      static
      symbol_type
      make_KEYWORD (string * v)
      {
        return symbol_type (token::KEYWORD, std::move (v));
      }
#else
      static
      symbol_type
      make_KEYWORD (const string *& v)
      {
        return symbol_type (token::KEYWORD, v);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      symbol_type
      make_OPERATOR (string * v)
      {
        return symbol_type (token::OPERATOR, std::move (v));
      }
#else
      static
      symbol_type
      make_OPERATOR (const string *& v)
      {
        return symbol_type (token::OPERATOR, v);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      ...
      static
      symbol_type
      make_PUNCTUATION (string * v)
      {
        return symbol_type (token::PUNCTUATION, std::move (v));
      }
#else
      static
      symbol_type
      make_PUNCTUATION (const string *& v)
      {
        return symbol_type (token::PUNCTUATION, v);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      ...
      make_BRACKETS ()
      {
        return symbol_type (token::BRACKETS);
      }
#else
      static
      symbol_type
      ...
      make_PARENTHESIS ()
      {
        return symbol_type (token::PARENTHESIS);
      }
#else
      static
      symbol_type
