...
#line 807 "parser.tab.cc"
  ...
  parser::yydefact_[] =
  {
       4,     0,    13,     0,     2,     4,     0,    16,    11,    12,
      14,     6,     7,     8,     9,    10,     1,     3,    17,     5,
      18,    15
  };
  ...
  parser::yystos_[] =
  {
       0,     3,    16,    18,    19,    20,    21,    23,    24,    25,
      26,    27,    28,    29,    30,    16,     0,    19,     4,    16,
      22,    21
  };
  ...
  "INTCONST", "REAL", "STRING", "PUNCTUATION", "ID", "'+'", "'-'", "'*'",
  "'/'", "'%'", "UMINUS", "';'", "$accept", "program", "statements",
  "stmt", "expr", "op", "term", "block", "funcdef", "assignexpr", "ifstmt",
